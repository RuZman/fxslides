...
public abstract class AbstractPoint {
	...
	protected void update(Frame frame, Vector point, Vector stabilizedPoint, Vector velocity) {
		this.point = point;
		this.velocity = velocity;
		
		TrackingBox trackingBox = LeapApp.getTrackingBox();
	...
	public final void setDiameter(Vector diameter) {
		// FIXME:
		if (diameter != null) {
			maxXPos = (float) (getTrackedAreaWidth() - diameter.getX());
			minYPos = (float) (getTrackedAreaHeight() - diameter.getY());
		}
